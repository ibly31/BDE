...
{
    if (tvm == nil) {
        tvm = [[AmazonTVMClient alloc] initWithEndpoint:@"http://blockdude.elasticbeanstalk.com/" useSSL:NO];
    }
...
+(bool)hasCredentials
{
    return YES;//return ![TOKEN_VENDING_MACHINE_URL isEqualToString:@"CHANGE ME"];
}
